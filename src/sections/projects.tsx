                  ...
                  <div className="flex gap-3 pt-2 border-t border-white/5">
                    {project.liveUrl && (
                      <a
                        ...
                        className="flex-1 px-3 py-2 text-xs font-semibold rounded-xl bg-blue-600 hover:bg-blue-700 text-white flex items-center justify-center gap-1.5 transition-all"
                      >
                    ...
                    {project.githubUrl && (
                      <a
                        ...
                        target="_blank"
                        rel="noopener noreferrer"
                        className="flex-1 px-3 py-2 text-xs font-semibold rounded-xl border border-white/10 hover:border-blue-500/50 hover:bg-blue-500/5 text-slate-300 hover:text-white flex items-center justify-center gap-1.5 transition-all"
                      >
                        <Github size={13} />
                        Source Code
                      </a>
